...
window.OUKA_I18N = {
  ...
  ja: {
    ...
    flow: {
      ...
      m4: "1〜6か月", step4: "日本語＋職業＋生活の教育", d4: "週5日・10:00〜18:00。現場のリズムで、日本語・現場訓練・職場ルールを一体で学びます。",
  ...
  en: {
    ...
    flow: {
      ...
      m4: "Months 1-6", step4: "Japanese + vocational + life education", d4: "5 days/week, 10:00-18:00. Japanese, on-site training, and workplace rules at the rhythm of a real site.",
  ...
  ne: {
    ...
    flow: {
      ...
      m4: "१–६ महिना", step4: "जापानी + पेसागत + जीवन शिक्षा", d4: "हप्तामा ५ दिन, १०:००–१८:००। वास्तविक साइटको लयमा सिकाइ।",
